...
/**
 * The runTest class to access the browser, which extends the capabilities of the standard Webdriver
 */
public final class Browser {
	...
	private static void initProperties() {
		...
		PropertiesResourceManager propUrls = new PropertiesResourceManager("stage.properties");
		stageProperty = System.getProperty(STAGE, STAGE_A);
		String choosenStage = propUrls.getProperty(stageProperty);
